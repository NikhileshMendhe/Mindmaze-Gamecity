...
import { ExternalLink, Clock, Users, Trophy } from "lucide-react";
...
interface LevelGameCardProps {
  game: LevelGame;
}

const LevelGameCard = ({ game }: LevelGameCardProps) => {
  ...
  return (
    <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl border border-yellow-500/20 hover:border-yellow-500/40 transition-all duration-200 group overflow-hidden">
      ...
      <div className="p-4">
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-500 hover:to-orange-500 text-white py-2 px-4 rounded-lg transition-all duration-200 flex items-center justify-center space-x-2"
        >
          <Trophy size={16} />
